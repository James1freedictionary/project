...
# 0 "<command-line>" 2
# 1 "test.c"
[01m[Ktest.c:2:22:[m[K [01;35m[Kwarning: [m[Kextra tokens at end of #undef directive
    2 | #undef __GNUC_PREREQ [01;35m[K([m[K3, 3)
      |                      [01;35m[K^[m[K
...
# 5 "product.h"
struct product ;
void scan_p(struct product*, int );
void print_p(struct product*, int);
void run_p();
# 4 "test.c" 2
